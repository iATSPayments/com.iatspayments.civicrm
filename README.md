...
2ABC80 account: subaccount configured to connected with iATS WebServices - can also access iATSpaymnents.com - but journal functionality only (no refund capability). The 80 account has a different password than the 01 account. 
