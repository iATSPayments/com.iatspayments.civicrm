...
return [
  'iats_email_recurring_failure_report' => [
    ...
    'default' => '',
    'html_type' => 'text',
    'title' => E::ts('Contiribution Failure Reports Email'),
    'description' => E::ts('Email Recurring Contribution failure reports to this Email address'),
    'is_domain' => 1,
    'is_contact' => 0,
  ...
  'iats_bcc_email_recurring_failure_report' => [
    ...
    'default' => '',
    'html_type' => 'email',
    'title' => E::ts('BCC Email'),
    'description' => E::ts('BCC Email Recurring Contribution failure reports to this Email address.'),
    'is_domain' => 1,
    'is_contact' => 0,
  ...
  'iats_recurring_failure_threshhold' => [
    ...
    'default' => 3,
    'html_type' => 'text',
    'title' => E::ts('Maximum failure threshold'),
    'description' => E::ts('When failure count is equal to or greater than this number, push the next scheduled contribution date forward'),
    'is_domain' => 1,
    'is_contact' => 0,
    'settings_pages' => ['iats' => ['weight' => 30]],
  ],
  'iats_recurring_revert_onfailure' => [
    'name' => 'iats_recurring_revert_onfailure',
    'type' => 'Boolean',
    'default' => 0,
    'html_type' => 'checkbox',
    'title' => E::ts('Revert to non-recurring Contribution/Membership after maximum failure reached'),
    'description' => E::ts('Do you want to revert/cancel the recurring contribution to a regular contribution when the failure is reached. For example, Memberships would require members to renew manually upon X failures.'),
    'is_domain' => 1,
    'is_contact' => 0,
    'settings_pages' => ['iats' => ['weight' => 35]],
  ],
  'iats_receipt_recurring' => [
    ...
    'default' => '',
    'html_type' => 'select',
    'title' => E::ts('Email receipts?'),
    'description' => E::ts('Email receipt for a Contribution in a Recurring Series'),
    'is_domain' => 1,
    'is_contact' => 0,
  ...
  'iats_ach_category_text' => [
    ...
    'html_type' => 'text',
    'title' => E::ts('ACH Category Text'),
    'description' => E::ts('ACH Category Text (only applies to FirstAmerican).'),
    'is_domain' => 1,
    'is_contact' => 0,
  ...
  'iats_days' => [
    ...
    'title' => E::ts('Restrict allowable days of the month'),
    'description' => E::ts('Restrict allowable days of the month for Recurring Contributions'),
    'is_domain' => 1,
    'is_contact' => 0,
